...
<div class="container">
    <div class="text-center">
          <a class="mt-4 btn btn-success" href="{{route('posts.create')}}"> create posts</a>
          <a class="mt-4 btn btn-warning" href="{{route('posts.archive')}}"> Archive</a>
    ...
    <table class="table mt-4">
        ...
        <tr>
            ...
            <td scope="col">{{$post["created_at"]->format('d-m-Y')}}</td>
            ...
            <td>  <a href="{{route('posts.show',$post['id'])}}" class="btn btn-info">View</a>
                ...
                <a href="{{route('posts.destroy',$post['id'])}}" class="btn btn-danger" onclick="return confirm('Are you sure?')" >Delete</a></td>
        </tr>
        @endforeach
